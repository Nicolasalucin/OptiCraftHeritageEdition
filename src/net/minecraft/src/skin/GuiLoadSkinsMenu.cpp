...
void GuiLoadSkinsMenu::initGui()
{
    ...
    controlList.push_back(new GuiButton(1, centerX, startY, btnW, btnH, "Load from USB Storage (Recommended)"));
    controlList.push_back(new GuiButton(2, centerX, startY + 28, btnW, btnH, "Load from Device"));
